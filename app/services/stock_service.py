...
# 종목 조회
async def get_stock_info(db: AsyncSession, stock_code: str):
...
# 이평선 데이터 조회
async def get_day_stock_price(db: AsyncSession, code: str, start_date: datetime):
    return await select_stock_hstr(db, code, start_date)