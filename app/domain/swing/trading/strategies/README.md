...
#### [개장 보호] Opening Guard (노이즈 방지)

- 개장 후 **10분간** (국내 09:00~09:10, 나스닥 09:30~09:40 ET)
- PEAK_PRICE 갱신: 장중고가 대신 **현재가**로 갱신 (시초가 스파이크 방지)
- 익절 체크: **스킵** (가짜 신호 방지)
- 손절 체크: **유지** (급락 방어)
...
| **개장 보호** | | |
| OPENING_GUARD_MINUTES | 10 | 개장 후 PEAK 보호 기간 (분) |
| **손절** | | |
...
| **손절** | 실시간 현재가 기준 | 일일 저가 기준 |
| **1차 익절** | 현재가 ≤ PEAK - ATR×2.0 → 50% 매도 | 저가 기준 동일 |
| **2차 익절** | ATR×2.0 + OBV-Z < -0.5 → 잔량 매도 | 동일 |
